...
画像に書かれた数字を全て読み取り、以下の形式でリストアップしてください：
  数字リスト：980, 450, 600, 500, 100, 440, 30 （例）
★注意：「980」を「80」と誤読しないでください。手書きでも全桁を正確に読んでください。

【アイソメ図の寸法の読み方】
アイソメ図（斜め立体図）では寸法の位置と方向で意味が決まります：
- 天面（上の面）の左右方向の寸法 → 幅（W）
- 天面（上の面）の奥行き方向の寸法 → 奥行き（D）
- 側面の垂直方向の寸法 → 高さ（H）
- 「t20」「板厚20」などの表記 → 板の厚み
